package uni.task_diploma.constants;

import lombok.experimental.UtilityClass;

@UtilityClass
public class ParseFieldRasp {

    public static final String RASP_DAY = "table.table.m-table.mb-5";
    ...
    public static final String CLASS_LECTORS = "a.kt-link";
}
